      ...
      <div className="image-container">
        ...
        <div className="background">
          <div className="background-top">Background</div>
            ...
            <div className="subtitle">
            <span class="text-spike">✹ </span>Variable Gathering and Documentation<span class="text-spike">✹ </span></div>
            <div className="body-content">
              <p>
          ...
          <div className="experienceSection" id='background'>
            ...
            <div className='experienceContainer'>
          <div className="experienceSection">
            <div className="subtitle"><span class="text-spike">✹ </span>Incorporating Gravitational Influences<span class="text-spike">✹ </span></div>
            <div className="body-content">
              <p>
